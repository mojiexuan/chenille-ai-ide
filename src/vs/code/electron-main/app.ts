...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting Chenille');
		...
		// "com.microsoft.", which breaks native tabs for Chenille when using this
