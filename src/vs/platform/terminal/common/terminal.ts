...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Chenille's "shell environment" that may
	 ...
	 * a terminal used to drive some Chenille feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Chenille and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Chenille shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
