...
const newUntitledFile: WatermarkEntry = { text: localize('watermark.newUntitledFile', "新建无标题文本文件"), id: 'workbench.action.files.newUntitledFile' };
...
const startDebugging: WatermarkEntry = { text: localize('watermark.startDebugging', "启动调试"), id: 'workbench.action.debug.start', when: { web: ContextKeyExpr.equals('terminalProcessSupported', true) } };
const openSettings: WatermarkEntry = { text: localize('watermark.openSettings', "打开设置"), id: 'workbench.action.openSettings' };
