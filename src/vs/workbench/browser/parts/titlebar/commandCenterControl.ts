...
class CommandCenterCenterViewItem extends BaseActionViewItem {
	...
	protected override getTooltip() {
		...
		const title = kb
			? localize('title', "搜索 {0} ({1}) \u2014 {2}", this._windowTitle.workspaceName, kb, this._windowTitle.value)
			: localize('title2', "搜索 {0} \u2014 {1}", this._windowTitle.workspaceName, this._windowTitle.value);
