 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Chenille UI).
 */
 ...
 * to represent terminals that appear in other parts of the Chenille UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Chenille OSC `SetMarker`
