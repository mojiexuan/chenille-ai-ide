...
/**
 * Allows webviews to monitor when an element in the Chenille editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Chenille needs to see this
