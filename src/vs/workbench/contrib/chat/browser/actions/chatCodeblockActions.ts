			...
			return instantiationService.createInstance(class extends MenuEntryActionViewItem {
				protected override getTooltip(): string {
					...
					if (isCodeBlockActionContext(context) && context.codemapperUri) {
						...
						return localize('interactive.applyInEditorWithURL.label', "应用到 {0}", label);
					}
	...
	registerAction2(class CopyCodeBlockAction extends Action2 {
		constructor() {
			super({
				...
				title: localize2('interactive.copyCodeBlock.label', "复制"),
				f1: false,
	...
	registerAction2(class SmartApplyInEditorAction extends ChatCodeBlockAction {
		...
		constructor() {
			super({
				...
				title: localize2('interactive.applyInEditor.label', "在编辑器中应用"),
	...
	registerAction2(class InsertAtCursorAction extends ChatCodeBlockAction {
		constructor() {
			super({
				...
				title: localize2('interactive.insertCodeBlock.label', "在光标处插入"),
				precondition: ChatContextKeys.enabled,
				f1: true,
				category: CHAT_CATEGORY,
				icon: Codicon.insert,
	...
	registerAction2(class InsertIntoNewFileAction extends ChatCodeBlockAction {
		constructor() {
			super({
				...
				title: localize2('interactive.insertIntoNewFile.label', "插入到新文件"),
				precondition: ChatContextKeys.enabled,
				f1: true,
				category: CHAT_CATEGORY,
	...
	registerAction2(class RunInTerminalAction extends ChatCodeBlockAction {
		constructor() {
			super({
				...
				title: localize2('interactive.runInTerminal.label', "插入到终端"),
				precondition: ChatContextKeys.enabled,
				f1: true,
				category: CHAT_CATEGORY,
	...
	registerAction2(class NextCodeBlockAction extends Action2 {
		constructor() {
			super({
				...
				title: localize2('interactive.nextCodeBlock.label', "下一个代码块"),
				keybinding: {
	...
	registerAction2(class PreviousCodeBlockAction extends Action2 {
		constructor() {
			super({
				...
				title: localize2('interactive.previousCodeBlock.label', "上一个代码块"),
				keybinding: {
	...
	registerAction2(class ApplyEditsCompareBlockAction extends ChatCompareCodeBlockAction {
		constructor() {
			super({
				...
				title: localize2('interactive.compare.apply', "应用编辑"),
				f1: false,
				category: CHAT_CATEGORY,
				icon: Codicon.gitPullRequestGoToChanges,
	...
	registerAction2(class DiscardEditsCompareBlockAction extends ChatCompareCodeBlockAction {
		constructor() {
			super({
				...
				title: localize2('interactive.compare.discard', "放弃编辑"),
				f1: false,
				category: CHAT_CATEGORY,
				icon: Codicon.trash,
				precondition: ContextKeyExpr.and(EditorContextKeys.hasChanges, ChatContextKeys.editApplied.negate()),
