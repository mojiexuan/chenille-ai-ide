...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Chenille in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Chenille and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
