...
- 🧩 **MCP 支持** - 完整支持 MCP (Model Context Protocol)，自定义工具无限扩展
...
| --------------- | ------------------------------------------------------------ | ------------------------- |
| v0.0.1          | [v1.107.1](https://github.com/microsoft/vscode/tree/1.107.1) | 2026 年 1 月 11 日 21:53  |
