...
declare namespace Fig {
	...
	interface Generator {
		...
		script?:
		| string[]
		| Function<string[], string[] | undefined> // <-- Chenille edit to make results correct
		| ExecuteCommandInput
		 ...
		 *
		 */
		postProcess?: (out: string, tokens: string[]) => (Suggestion | null)[] | undefined; // <-- Chenille edit to make results correct
		/**
		...
		) => Promise<(Suggestion | null)[] | undefined>; // <-- Chenille edit to make results correct
		/**
		 *
